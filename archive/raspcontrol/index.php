...
<html lang="en">
    ...
    <body>
        ...
        <header>
            <div class="container">
                ...
                <h1><a href="<?php echo INDEX; ?>">Control Panel</a></h1>
                ...
                <div class="container">
                    ...
                    <div class="nav-collapse collapse">
                        <ul class="nav">
							...
							<li<?php is_active('charts'); ?>><a href="<?php echo CHARTS; ?>"><i class="icon-disks icon-white"></i> Charts</a></li>
                        </ul>
    ...
    <footer>
        <div class="container">
            <p>Powered by <a href="http://www.raspberrypi.org/">Raspberry Pi</a>.</p>
        </div>
    </footer>
